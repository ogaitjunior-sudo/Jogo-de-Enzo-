...
const STORY_CHALLENGES: Record<StoryChallengeId, readonly StoryChallengeVariant[]> = {
  newton: [
    {
      prompt: "Newton ergue três anéis de energia e grava no ar: 2³ + 4. Qual valor quebra o primeiro selo?",
      answer: 12,
      hint: "Resolva a potência antes da soma.",
      explanation: "2³ = 8. Depois, 8 + 4 = 12.",
    ...
    {
      prompt: "No centro da quadra, a fórmula pulsa: 3² + 2³. Qual número abre caminho até Newton?",
      answer: 17,
      hint: "Calcule cada potência e depois some os resultados.",
      explanation: "3² = 9 e 2³ = 8. Somando, o corredor responde com 17.",
    ...
    {
      prompt: "A última muralha de Newton mostra: (2⁴ - 3²) + 5. Qual valor desmonta o golpe final?",
      answer: 12,
      hint: "Primeiro resolva as potências, depois a subtração e, por fim, a soma.",
      explanation: "2⁴ = 16 e 3² = 9. 16 - 9 = 7. Com mais 5, o total é 12.",
  ...
  einstein: [
    {
      prompt: "No labirinto, uma porta só abre com √81 - 4. Qual resultado acalma o espelho central?",
      answer: 5,
      hint: "Descubra √81 antes de subtrair.",
      explanation: "√81 = 9. Então 9 - 4 = 5.",
    ...
    {
      prompt: "Einstein cria duas saídas falsas. Ambas apontam para √64 + 6. Qual número confirma a porta real?",
      answer: 14,
      hint: "√64 vale 8.",
      explanation: "√64 = 8. Somando 6, a chave correta fica em 14.",
    ...
    {
      prompt: "No núcleo do labirinto, a conta final aparece: (3² + √36) × 2. Qual resposta desfaz a armadilha?",
      answer: 30,
      hint: "Resolva 3², some com √36 e multiplique o resultado por 2.",
      explanation: "3² = 9 e √36 = 6. 9 + 6 = 15. 15 × 2 = 30.",
  ...
  marcela: [
    {
      prompt: "A energia da relíquia cruza o peito de Marcela com √49 + 2³. Qual valor corta a corrupção?",
      answer: 15,
      hint: "√49 vale 7 e 2³ vale 8.",
    ...
    {
      prompt: "Para acordá-la, o Sétimo A projeta: (2³ + √16) × 2. Qual número limpa a segunda camada?",
      answer: 24,
      hint: "2³ = 8 e √16 = 4.",
    ...
    {
      prompt: "No confronto final, a relíquia acende: 3² + √81 + 2⁴. Qual valor sela o caos?",
      answer: 34,
      hint: "Resolva cada bloco separadamente e some no final.",
      explanation: "3² = 9, √81 = 9 e 2⁴ = 16. No total, 34.",
