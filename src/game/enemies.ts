...
const APPRENTICE_AVATAR_BY_NAME: Record<string, ApprenticeAvatarConfig> = {
  ...
  "Estagiario de Lab": { image: estagiarioDeLabImg, imagePosition: "center 20%", imageScale: 1.12 },
  "Genio Junior": { image: genioJuniorImg, imagePosition: "center 18%", imageScale: 1.11 },
